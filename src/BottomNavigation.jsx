            ...
            <NavLink className={styles.itemContainer} to="/home">
                {
                    ({isActive}) => (
                        <>
                            <img className={styles.imageWrapper} src={isActive ? icMainPageActive : icMainPage} alt="ic home"/>
            ...
            <NavLink className={styles.itemContainer} to="/showup">
                {
                    ({isActive}) => (
                        <>
                            <img className={styles.imageWrapper} src={isActive ? icShowUpActive : icShowUp} alt="ic showup"/>
